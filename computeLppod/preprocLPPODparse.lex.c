#line 2 "preprocLPPODparse.lex.c"

#line 4 "preprocLPPODparse.lex.c"
...
*/
#line 486 "preprocLPPODparse.lex.c"
...
#line 30 "preprocLPPODparse.ll"

#line 668 "preprocLPPODparse.lex.c"
...
case 1:
YY_RULE_SETUP
#line 31 "preprocLPPODparse.ll"
{ yylval =(char*)malloc(strlen(yytext)+1);
		 strcpy(yylval,yytext); return (IF);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 33 "preprocLPPODparse.ll"
return(yytext[0]);
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 34 "preprocLPPODparse.ll"
{ yylval =(char*)malloc(strlen(yytext)+1);
...
YY_RULE_SETUP
#line 40 "preprocLPPODparse.ll"
{ yylval =(char*)malloc(strlen(yytext)+1);
		 strcpy(yylval,yytext); return(COMMENT);}
	YY_BREAK
case 7:
#line 43 "preprocLPPODparse.ll"
case 8:
#line 44 "preprocLPPODparse.ll"
case 9:
...
case 10:
YY_RULE_SETUP
#line 46 "preprocLPPODparse.ll"
ECHO;
	YY_BREAK
#line 805 "preprocLPPODparse.lex.c"
