...
#line 30 "preprocLparse.l"

#line 668 "preprocLparse.lex.c"
...
YY_RULE_SETUP
#line 40 "preprocLparse.l"
{ yylval =(char*)malloc(strlen(yytext)+1);
		 strcpy(yylval,yytext); return(COMMENT);}
	YY_BREAK
case 7:
#line 43 "preprocLparse.l"
case 8:
...
case 10:
YY_RULE_SETUP
#line 46 "preprocLparse.l"
ECHO;
	YY_BREAK
#line 805 "preprocLparse.lex.c"
